...
def got_ladder_jump(old_value,current_value,player_name):
    ...
    print("\n" + player_name + " got ladder jump from " + str(old_value) + " to " + str(current_value))

def got_snake_bite(old_value,current_value,player_name):
    print("\n" + random.choice(snake_bite) + "-------->")
    print("\n" + player_name +" got snake bite from " + str(old_value) + " to " + str(current_value))
...
def snake_ladder(player_name,current_value,dice_value):
    ...
    if current_value>max_val:
        print("you need " + str(current_value-max_val) + " to win the game")
        return old_value
    print("\n" + player_name + " move from " + str(old_value) + " to " + str(current_value))
...
def start():
    ...
    while True:
        ...
        player1_current_pos = snake_ladder(player1_name, player1_current_pos, dice_value)
        ...
        player2_current_pos = snake_ladder(player2_name, player2_current_pos, dice_value)
